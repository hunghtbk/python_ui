...
//    height: 150
    ...
    Text {
        ...
        text: qsTr("Do you want to delete all tasks?")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("DeleteAllTaskNotification.qml - Cancel")
                notificationMain.taskLoaderItemEvent("evG_Cancel")
            }
        }
    }
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("DeleteAllTaskNotification.qml - OK")
                notificationMain.taskLoaderItemEvent("delete_all_tasks_ok")
            }
        }
    }
