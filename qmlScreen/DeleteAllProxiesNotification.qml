...
//    height: 150
    ...
    radius: 5
    signal deleteAllProxiesMessage(string msg)
    Text {
        id: marginLeft
        x: 0
        y: 0
    ...
    Text {
        ...
        text: qsTr("Do you want to delete all proxies?")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("DeleteAllProxiesNotification.qml - Cancel")
                notificationMain.deleteAllProxiesMessage("delete_all_proxies_cancel")
            }
        }
    }
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("DeleteAllProxiesNotification.qml - OK")
                notificationMain.deleteAllProxiesMessage("delete_all_proxies_ok")
            }
        }
    }
