...
//    height: 300
    ...
    property int currentWidth: m_createTaskGroupScreen.width
    property int currentHeight: m_createTaskGroupScreen.height
    ...
    Text {
        id: createTaskScreenborderLeftMain
        x: 0
        y: 0
        width: 0
        height: 0
...
//        y: 16
        ...
        anchors.left: createTaskScreenborderLeftMain.right
        anchors.leftMargin: (15/defaultWidth)* parent.width //x
        anchors.top: createTaskScreenborderLeftMain.bottom
...
//        y: 7
    ...
    MouseArea {
        ...
        onClicked: {
            console.log(" Create Task Group Screen")
            m_createTaskGroupScreen.signalFromCreateScreen("evG_Cancel");
        }
    }
