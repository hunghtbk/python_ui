...
//    height: 150
    ...
    Text {
        ...
        text: qsTr("Do you want to start all tasks?")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("StartAllTaskNotification.qml - Cancel")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("StartAllTaskNotification.qml - OK")
                notificationMain.taskLoaderItemEvent("start_all_tasks_ok")
            }
        }
    }
