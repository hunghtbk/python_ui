...
//    height: 150
    ...
    Text {
        ...
        text: qsTr("Do you want to stop all tasks?")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("StopAllTaskNotification.qml - Cancel")
...
//        y: 100
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                console.log("StopAllTaskNotification.qml - OK")
                notificationMain.taskLoaderItemEvent("stop_all_tasks_ok")
            }
        }
    }
